...
<div class="border p-6 bg-white min-h-[50vh]">
    <h1 class="text-2xl font-bold border-b pb-4 mb-6">Koleksi Favorit ❤️</h1>
            ...
            @foreach($favorites as $book)
                <div class="border flex flex-col h-full hover:border-black transition group relative">
                    ...
                    <div class="p-3 flex flex-col grow">
                        ...
                        <a href="{{ route('books.show', $book->slug) }}" class="mt-auto border text-center py-1.5 text-xs font-bold uppercase hover:bg-black hover:text-white transition">
                            Lihat
                        </a>
                    </div>
                </div>
